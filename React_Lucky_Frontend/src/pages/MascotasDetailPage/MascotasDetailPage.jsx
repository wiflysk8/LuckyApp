  ...
  <img className="c-detail__box__right__img" src={Compartir} alt="icon"/>
        ...
        <div>
          <div className="c-detail__tag">
            <h4 className={active ? "c-detail__tag__h4" : "c-detail__tag__h4-active"}  onClick={() => {setShowDetails("datos"); setActive(false); setActive2(true); setActive3(true)}}>Datos</h4>
            <h4 className={active2 ? "c-detail__tag__h4" : "c-detail__tag__h4-active"} onClick={() => {setShowDetails("salud"); setActive(true); setActive2(false); setActive3(true) }}>Salud</h4>
            <h4 className={active3 ? "c-detail__tag__h4" : "c-detail__tag__h4-active"} onClick={() => {setShowDetails("adopcion"); setActive(true); setActive2(true); setActive3(false) }}>Adopcion</h4>
          </div>
          <div>
            {showDetails === "datos" && <Datos mascotaDetail={mascotaDetail} />}
            {showDetails === "salud" && <Salud mascotaDetail={mascotaDetail} />}
            {showDetails === "adopcion" && (
              <Adopcion mascotaDetail={mascotaDetail} />
            )}
          </div>
        </div>
       <p>HOLAHOLA</p>
